...
1.  ConfigExamples/Intercept/FedoraCoreWccp2Receiver
2.  ConfigExamples/Intercept/FreeBsdWccp
    2Receiver
...
<!-- end list -->
  ...
  - [Linux TPROXY Real Transparent Interception (without
    NAT)](https://wiki.squid-cache.org/ConfigExamples/Intercept/Features/Tproxy4#)

[CategoryConfigExample](https://wiki.squid-cache.org/ConfigExamples/Intercept/CategoryConfigExample#)
