# Configuring Transparent Interception with Fedora Core Linux and WCCPv2
  ...
  - *by
    [ReubenFarrelly](https://wiki.squid-cache.org/ConfigExamples/Intercept/FedoraCoreWccp2Receiver/ReubenFarrelly#)*
...
## Squid Configuration File
  ...
  - ![{i}](https://wiki.squid-cache.org/wiki/squidtheme/img/icon-info.png)
    From
    [Squid-3.1](https://wiki.squid-cache.org/ConfigExamples/Intercept/FedoraCoreWccp2Receiver/Squid-3.1#)
...
[CategoryConfigExample](https://wiki.squid-cache.org/ConfigExamples/Intercept/FedoraCoreWccp2Receiver/CategoryConfigExample#)
