*by
[YuriVoinov](https://wiki.squid-cache.org/ConfigExamples/CoinMiners/YuriVoinov#)*
...
script](https://wiki.squid-cache.org/ConfigExamples/CoinMiners/ConfigExamples/CoinMiners?action=AttachFile&do=get&target=update_miners.sh):
...
picture](https://wiki.squid-cache.org/ConfigExamples/CoinMiners/ConfigExamples/CoinMiners?action=AttachFile&do=get&target=C89L68e.png).

[CategoryConfigExample](https://wiki.squid-cache.org/ConfigExamples/CoinMiners/CategoryConfigExample#)
