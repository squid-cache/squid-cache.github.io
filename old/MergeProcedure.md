...
2.  Implement your changes while following
    [SquidCodingGuidelines](https://wiki.squid-cache.org/MergeProcedure/SquidCodingGuidelines#).
    Use git for version control (see
    [GitHints](https://wiki.squid-cache.org/MergeProcedure/GitHints#)).
...
5.  Monitor for automated test failures and work with reviewers to get
    enough [\#Votes](#Votes),
    [updating](https://wiki.squid-cache.org/MergeProcedure/GitHints#Update_a_previously_submitted_pull_request)
...
requirements. See
[GitHints](https://wiki.squid-cache.org/MergeProcedure/GitHints#) for PR
submission recipes.
...
The [core
developers](https://wiki.squid-cache.org/MergeProcedure/WhoWeAre#)
