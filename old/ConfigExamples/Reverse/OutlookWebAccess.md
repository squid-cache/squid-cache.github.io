...
SOLUTION:
  ...
  - [Squid-2.7](https://wiki.squid-cache.org/ConfigExamples/Reverse/OutlookWebAccess/Squid-2.7#)
    and
    [Squid-3.1](https://wiki.squid-cache.org/ConfigExamples/Reverse/OutlookWebAccess/Squid-3.1#)
    offer the
    ...
    [Squid-3.2](https://wiki.squid-cache.org/ConfigExamples/Reverse/OutlookWebAccess/Squid-3.2#)
...
[CategoryConfigExample](https://wiki.squid-cache.org/ConfigExamples/Reverse/OutlookWebAccess/CategoryConfigExample#)
