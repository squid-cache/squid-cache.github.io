...
|                                                                      |                                                                                                                                                                                                           |
| -------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![/\!\\](https://wiki.squid-cache.org/wiki/squidtheme/img/alert.png) | Balabit now only support TPROXY v4.1 which has been integrated with the 3.1 squid code (see [Features/Tproxy4](https://wiki.squid-cache.org/ConfigExamples/FullyTransparentWithTPROXY/Features/Tproxy4#)) |
...
[Squid-2.6](https://wiki.squid-cache.org/ConfigExamples/FullyTransparentWithTPROXY/Squid-2.6#)
...
## References
  ...
  - Squid
    [Features/Tproxy4](https://wiki.squid-cache.org/ConfigExamples/FullyTransparentWithTPROXY/Features/Tproxy4#)
...
<!-- end list -->
  ...
  - [CategoryConfigExample](https://wiki.squid-cache.org/ConfigExamples/FullyTransparentWithTPROXY/CategoryConfigExample#)
