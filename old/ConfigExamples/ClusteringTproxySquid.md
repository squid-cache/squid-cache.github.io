...
balanced using
[RoundRobin](https://wiki.squid-cache.org/ConfigExamples/ClusteringTproxySquid/RoundRobin#)
...
On customed built of squid you must include:
  ...
  - [CategoryConfigExample](https://wiki.squid-cache.org/ConfigExamples/ClusteringTproxySquid/CategoryConfigExample#)
