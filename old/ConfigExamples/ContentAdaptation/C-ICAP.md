# Using c-icap for proxy content antivirus checking on-the-fly
  ...
  - *by
    [YuriVoinov](https://wiki.squid-cache.org/ConfigExamples/ContentAdaptation/C-ICAP/YuriVoinov#)*
...
For
[Squid-3.0](https://wiki.squid-cache.org/ConfigExamples/ContentAdaptation/C-ICAP/Squid-3.0#)
...
for
[Squid-3.4](https://wiki.squid-cache.org/ConfigExamples/ContentAdaptation/C-ICAP/Squid-3.4#)
...
[icap\_stats](https://wiki.squid-cache.org/ConfigExamples/ContentAdaptation/C-ICAP/ConfigExamples/ContentAdaptation/C-ICAP?action=AttachFile&do=get&target=icap_stats)
[icap\_sem](https://wiki.squid-cache.org/ConfigExamples/ContentAdaptation/C-ICAP/ConfigExamples/ContentAdaptation/C-ICAP?action=AttachFile&do=get&target=icap_sem)
[icap\_mem](https://wiki.squid-cache.org/ConfigExamples/ContentAdaptation/C-ICAP/ConfigExamples/ContentAdaptation/C-ICAP?action=AttachFile&do=get&target=icap_mem)
