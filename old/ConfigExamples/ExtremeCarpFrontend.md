...
[ConfigExamples/MultiCpuSystem](https://wiki.squid-cache.org/ConfigExamples/ExtremeCarpFrontend/ConfigExamples/MultiCpuSystem#):
...
1.  the administrator has set up a farm of backend servers, using the
    means suggested in
    [MultipleInstances](https://wiki.squid-cache.org/ConfigExamples/ExtremeCarpFrontend/MultipleInstances#)
...
### Frontend Balancer Alternative 1: iptables
  ...
  - *by
    [FrancescoChemolli](https://wiki.squid-cache.org/ConfigExamples/ExtremeCarpFrontend/FrancescoChemolli#)*
...
[CategoryConfigExample](https://wiki.squid-cache.org/ConfigExamples/ExtremeCarpFrontend/CategoryConfigExample#)
