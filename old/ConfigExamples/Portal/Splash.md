...
[Squid-3.2](https://wiki.squid-cache.org/ConfigExamples/Portal/Splash/Squid-3.2#)
...
[Squid-3.1](https://wiki.squid-cache.org/ConfigExamples/Portal/Splash/Squid-3.1#)
and older:
...
## Configuration tweaks
  ...
  - Dependency on an external web server to publish the splash page can
    ...
    error](https://wiki.squid-cache.org/ConfigExamples/Portal/Splash/Features/CustomErrors#)
...
[CategoryConfigExample](https://wiki.squid-cache.org/ConfigExamples/Portal/Splash/CategoryConfigExample#)
