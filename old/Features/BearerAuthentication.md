# Feature: Bearer Authentication
  ...
  - **Developer**:
    [AmosJeffries](https://wiki.squid-cache.org/Features/BearerAuthentication/AmosJeffries#)
...
See
[Features/Authentication](https://wiki.squid-cache.org/Features/BearerAuthentication/Features/Authentication#)
  ...
  - key-extras
      ...
      - Additional parameters passed to the helper which may be
        ...
        *key\_extras* parameter. Only available in
        [Squid-3.5](https://wiki.squid-cache.org/Features/BearerAuthentication/Squid-3.5#)
        and later.
...
Result line sent back to Squid:
  ...
  - kv-pair
      ...
      - One or more key=value pairs. The key names reserved on this
        ...
        <td><p>Tag the client TCP connection (<a href="https://wiki.squid-cache.org/Features/BearerAuthentication/Squid-3.5#">Squid-3.5</a>)</p></td>
        </tr>
        <tr class="even">
        <td><p>group=...</p></td>
        <td><p>reserved</p></td>
...
[CategoryFeature](https://wiki.squid-cache.org/Features/BearerAuthentication/CategoryFeature#)
