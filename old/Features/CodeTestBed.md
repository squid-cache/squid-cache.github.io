# Feature: Source Code Testing
  ...
  - **Developer**:
    [AmosJeffries](https://wiki.squid-cache.org/Features/CodeTestBed/AmosJeffries#),
    [AlexRousskov](https://wiki.squid-cache.org/Features/CodeTestBed/AlexRousskov#),
    [FrancescoChemolli](https://wiki.squid-cache.org/Features/CodeTestBed/FrancescoChemolli#),
    everyone
...
| 4         | **DONE**      | Test scheduling on multiple OS see [BuildFarm](https://wiki.squid-cache.org/Features/CodeTestBed/BuildFarm#)        |
| 5         | **DONE**      | Automated defect tracking see [CoverityTesting](https://wiki.squid-cache.org/Features/CodeTestBed/CoverityTesting#) |
...
see
[BuildFarm](https://wiki.squid-cache.org/Features/CodeTestBed/BuildFarm#)
...
[Bazaar](https://wiki.squid-cache.org/Features/CodeTestBed/BzrInstructions#)
in part to make these changes easier and more manageable.

The code is being
[re-arranged](https://wiki.squid-cache.org/Features/CodeTestBed/Features/SourceLayout#)
...
[CategoryFeature](https://wiki.squid-cache.org/Features/CodeTestBed/CategoryFeature#)
