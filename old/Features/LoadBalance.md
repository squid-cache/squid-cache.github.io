...
sessions (such as
[Hotmail](https://wiki.squid-cache.org/Features/LoadBalance/KnowledgeBase/Hotmail#)).
...
[Squid-3.1](https://wiki.squid-cache.org/Features/LoadBalance/Squid-3.1#)
and older (it is outdated in this purpose by SMP support in
[Squid-3.2](https://wiki.squid-cache.org/Features/LoadBalance/Squid-3.2#)).
...
[CategoryFeature](https://wiki.squid-cache.org/Features/LoadBalance/CategoryFeature#)
|
[CategoryWish](https://wiki.squid-cache.org/Features/LoadBalance/CategoryWish#)
