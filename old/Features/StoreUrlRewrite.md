# Feature: Store URL Rewriting?
  ...
  - **Status**: deprecated. see
    [StoreID](https://wiki.squid-cache.org/Features/StoreUrlRewrite/Features/StoreID#)

  - **Version**: 2.7 (only)

  - **Developer**:
    [AdrianChadd](https://wiki.squid-cache.org/Features/StoreUrlRewrite/AdrianChadd#).
...
Input line received from Squid:
  ...
  - key-extras
      ...
      - Starting with
        [Squid-3.5](https://wiki.squid-cache.org/Features/StoreUrlRewrite/Squid-3.5#)
        ...
        [Squid-3.4](https://wiki.squid-cache.org/Features/StoreUrlRewrite/Squid-3.4#)
...
Result line sent back to Squid:
  ...
  - kv-pair
      ...
      - One or more key=value pairs. The key names reserved on this
        ...
        |                    |                                                                                                               |
        | ------------------ | ------------------------------------------------------------------------------------------------------------- |
        | clt\_conn\_tag=... | Tag the client TCP connection ([Squid-3.5](https://wiki.squid-cache.org/Features/StoreUrlRewrite/Squid-3.5#)) |
        | message=...        | reserved                                                                                                      |
...
[CategoryFeature](https://wiki.squid-cache.org/Features/StoreUrlRewrite/CategoryFeature#)
