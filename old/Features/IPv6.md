# IPv6 in Squid
  ...
  - **Developer**:
    [AmosJeffries](https://wiki.squid-cache.org/Features/IPv6/AmosJeffries#)
...
[Squid-3.1](https://wiki.squid-cache.org/Features/IPv6/Squid-3.1#). If
you are using a packaged version of 3.1 without it, please contact the
package maintainer about enabling it.
...
[Squid-3.2](https://wiki.squid-cache.org/Features/IPv6/Squid-3.2#).
...
around 2010 with the introduction of NAT66 and NPT66.
  ...
  - Linux [TPROXY
    v4](https://wiki.squid-cache.org/Features/IPv6/Features/Tproxy4#) is
    capable of IPv6. Kernel and iptables releases containing IPv6
...
From [Squid-3.2](https://wiki.squid-cache.org/Features/IPv6/Squid-3.2#)
...
[CategoryFeature](https://wiki.squid-cache.org/Features/IPv6/CategoryFeature#)
