# Feature: eCAP support
  ...
  - **Developer**:
    [AlexRousskov](https://wiki.squid-cache.org/Features/eCAP/AlexRousskov#)
...
[Squid-3.1](https://wiki.squid-cache.org/Features/eCAP/Squid-3.1#)
...
[Squid-3.2](https://wiki.squid-cache.org/Features/eCAP/Squid-3.2#)
...
[CategoryFeature](https://wiki.squid-cache.org/Features/eCAP/CategoryFeature#)
