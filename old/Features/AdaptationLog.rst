...
Most of the features described here are unofficially available for Squid v3.0 as a Launchpad [[https://code.launchpad.net/~rousskov/squid/3p0-plus|branch]]. Adaptation logging features are committed to Squid and scheduled for v3.1.0.11 release.
