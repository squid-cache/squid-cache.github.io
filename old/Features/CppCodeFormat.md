# Feature: C++ code formatting
  ...
  - **Developer**: Christos Tsantilas,
    [AmosJeffries](https://wiki.squid-cache.org/Features/CppCodeFormat/AmosJeffries#)
...
[CategoryFeature](https://wiki.squid-cache.org/Features/CppCodeFormat/CategoryFeature#)
