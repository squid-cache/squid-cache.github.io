# Feature: Refactor configure.in
  ...
  - **Developer**:
    [FrancescoChemolli](https://wiki.squid-cache.org/Features/ConfigureInRefactoring/FrancescoChemolli#)
...
[RobertCollins](https://wiki.squid-cache.org/Features/ConfigureInRefactoring/RobertCollins#)
...
[AmosJeffries](https://wiki.squid-cache.org/Features/ConfigureInRefactoring/AmosJeffries#)
...
[CategoryFeature](https://wiki.squid-cache.org/Features/ConfigureInRefactoring/CategoryFeature#)
