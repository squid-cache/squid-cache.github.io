# Feature: TPROXY version 4.1+ Support
  ...
  - **Developer**: Laszlo Attilla Toth (Balabit), Krisztian Kovacs,
    [AmosJeffries](https://wiki.squid-cache.org/Features/Tproxy4/AmosJeffries#)
...
## Minimum Requirements (IPv6 and IPv4)
  ...
  - ![{i}](https://wiki.squid-cache.org/wiki/squidtheme/img/icon-info.png)
    [Squid-3.4](https://wiki.squid-cache.org/Features/Tproxy4/Squid-3.4#)
...
It may also be seen only at startup due to unrelated issues:
  ...
  - [Another program already using the
    port](https://wiki.squid-cache.org/Features/Tproxy4/SquidFaq/TroubleShooting#head-97c3ff164d9706d3782ea3b242b6e409ce8395f6)

  - [Address not assigned to any
    interface](https://wiki.squid-cache.org/Features/Tproxy4/SquidFaq/TroubleShooting#head-19aa8aba19772e32d6e3f783a20b0d2be0edc6a2)
...
[CategoryFeature](https://wiki.squid-cache.org/Features/Tproxy4/CategoryFeature#)
