# Feature: Client side cleanup
  ...
  - **Developer**:
    [AmosJeffries](https://wiki.squid-cache.org/Features/ClientSideCleanup/AmosJeffries#)
...
[CategoryFeature](https://wiki.squid-cache.org/Features/ClientSideCleanup/CategoryFeature#)
[CategoryWish](https://wiki.squid-cache.org/Features/ClientSideCleanup/CategoryWish#)
