# Feature: SSL Server Certificate Validator
  ...
  - **Developer**:
    [AlexRousskov](https://wiki.squid-cache.org/Features/SslServerCertValidator/AlexRousskov#)

  - **More**: Not needed without
    [SslBump](https://wiki.squid-cache.org/Features/SslServerCertValidator/Features/SslBump#).
...
[CategoryFeature](https://wiki.squid-cache.org/Features/SslServerCertValidator/CategoryFeature#)
