...
5.  Reproduce the failing transaction, using a single request if
    ...
    [squidclient](https://wiki.squid-cache.org/SquidFaq/BugReporting/SquidClientTool#),
...
[KnowledgeBase/DebugSections](https://wiki.squid-cache.org/SquidFaq/BugReporting/KnowledgeBase/DebugSections#).
...
Back to the
[SquidFaq](https://wiki.squid-cache.org/SquidFaq/BugReporting/SquidFaq#)
