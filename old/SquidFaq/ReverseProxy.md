...
[ConfigExamples](https://wiki.squid-cache.org/SquidFaq/ReverseProxy/ConfigExamples#)
...
In
[Squid-3.1](https://wiki.squid-cache.org/SquidFaq/ReverseProxy/Squid-3.1#)
and later the
...
headers provided by backend servers.
  ...
  - Back to the
    [SquidFaq](https://wiki.squid-cache.org/SquidFaq/ReverseProxy/SquidFaq#)
