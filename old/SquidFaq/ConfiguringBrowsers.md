...
4.  [NAT or TPROXY
    interception](https://wiki.squid-cache.org/SquidFaq/ConfiguringBrowsers/ConfigExamples/Intercept#).
...
[sample1.pac.txt](https://wiki.squid-cache.org/SquidFaq/ConfiguringBrowsers/SquidFaq/ConfiguringBrowsers?action=AttachFile&do=get&target=sample1.pac.txt)
...
[sample2.pac.txt](https://wiki.squid-cache.org/SquidFaq/ConfiguringBrowsers/SquidFaq/ConfiguringBrowsers?action=AttachFile&do=get&target=sample2.pac.txt)
...
Starting with
[Squid-3.1](https://wiki.squid-cache.org/SquidFaq/ConfiguringBrowsers/Squid-3.1#),
...
by
[ReubenFarrelly](https://wiki.squid-cache.org/SquidFaq/ConfiguringBrowsers/ReubenFarrelly#)
...
Back to the
[SquidFaq](https://wiki.squid-cache.org/SquidFaq/ConfiguringBrowsers/SquidFaq#)
