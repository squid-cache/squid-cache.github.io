...
[../ConfiguringBrowsers](https://wiki.squid-cache.org/SquidFaq/RAID/SquidFaq/ConfiguringBrowsers#)
and
[Technology/ProxyPac](https://wiki.squid-cache.org/SquidFaq/RAID/Technology/ProxyPac#))
...
directories fails.
  ...
  - ![{i}](https://wiki.squid-cache.org/wiki/squidtheme/img/icon-info.png)
    There are
    [Plans](https://wiki.squid-cache.org/SquidFaq/RAID/Features/CacheDirFailover#)
