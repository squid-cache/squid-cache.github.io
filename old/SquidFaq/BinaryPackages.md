...
### [CentOS](https://wiki.squid-cache.org/SquidFaq/BinaryPackages/KnowledgeBase/CentOS)
...
### [Debian](https://wiki.squid-cache.org/SquidFaq/BinaryPackages/KnowledgeBase/Debian)
...
Add this to **/etc/apt/sources.list.d/testing** to enable the Debian
Buster/testing repository
...
### [Fedora](https://wiki.squid-cache.org/SquidFaq/BinaryPackages/KnowledgeBase/Fedora)
...
### [Fink](https://wiki.squid-cache.org/SquidFaq/BinaryPackages/KnowledgeBase/Fink)
...
### [FreeBSD](https://wiki.squid-cache.org/SquidFaq/BinaryPackages/KnowledgeBase/FreeBSD)
...
### [Gentoo](https://wiki.squid-cache.org/SquidFaq/BinaryPackages/KnowledgeBase/Gentoo)
...
### [Mandriva](https://wiki.squid-cache.org/SquidFaq/BinaryPackages/KnowledgeBase/Mandriva)
...
### [NetBSD](https://wiki.squid-cache.org/SquidFaq/BinaryPackages/KnowledgeBase/NetBSD)
...
### [OpenSUSE](https://wiki.squid-cache.org/SquidFaq/BinaryPackages/KnowledgeBase/OpenSUSE)
...
### [RedHat Enterprise Linux (RHEL)](https://wiki.squid-cache.org/SquidFaq/BinaryPackages/KnowledgeBase/RedHat)
...
### [Slackware](https://wiki.squid-cache.org/SquidFaq/BinaryPackages/KnowledgeBase/Slackware)
...
**Source**: SlackBuilds
  ...
  - [](http://slackbuilds.org/repository/14.1/network/squid/) (3.4.10 on
    [SlackWare](https://wiki.squid-cache.org/SquidFaq/BinaryPackages/SlackWare#)
    14.1)
...
### [Solaris](https://wiki.squid-cache.org/SquidFaq/BinaryPackages/KnowledgeBase/Solaris)
...
### [SLES](https://wiki.squid-cache.org/SquidFaq/BinaryPackages/KnowledgeBase/SLES)
...
### [Ubuntu](https://wiki.squid-cache.org/SquidFaq/BinaryPackages/KnowledgeBase/Ubuntu)
...
#### [(see Debian)](https://wiki.squid-cache.org/SquidFaq/BinaryPackages/KnowledgeBase/Debian)

Many versions of Ubuntu and Debian are routinely build-tested and
unit-tested as part of our
[BuildFarm](https://wiki.squid-cache.org/SquidFaq/BinaryPackages/BuildFarm#)
  ...
  - ![{i}](https://wiki.squid-cache.org/wiki/squidtheme/img/icon-info.png)
    The usual one requested is **libssl-dev** for SSL support.
      ...
      - ![/\!\\](https://wiki.squid-cache.org/wiki/squidtheme/img/alert.png)
        ...
        [Squid-3.5](https://wiki.squid-cache.org/SquidFaq/BinaryPackages/Squid-3.5#)
        ...
        [Squid-4](https://wiki.squid-cache.org/SquidFaq/BinaryPackages/Squid-4#)
        packages.
...
### [Windows](https://wiki.squid-cache.org/SquidFaq/BinaryPackages/KnowledgeBase/Windows)
...
<!-- end list -->
  ...
  - Back to the
    [SquidFaq](https://wiki.squid-cache.org/SquidFaq/BinaryPackages/SquidFaq#)
