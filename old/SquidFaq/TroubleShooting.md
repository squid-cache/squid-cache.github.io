...
[../SquidAcl](https://wiki.squid-cache.org/SquidFaq/TroubleShooting/SquidFaq/SquidAcl#)
...
[Eliezer
Croitoru](https://wiki.squid-cache.org/SquidFaq/TroubleShooting/Eliezer%20Croitoru#):
...
See
[../ProxyAuthentication](https://wiki.squid-cache.org/SquidFaq/TroubleShooting/SquidFaq/ProxyAuthentication#)
for further details
...
see
[SquidFaq/BugReporting](https://wiki.squid-cache.org/SquidFaq/TroubleShooting/SquidFaq/BugReporting#)
...
by
[HenrikNordström](https://wiki.squid-cache.org/SquidFaq/TroubleShooting/HenrikNordstr%C3%B6m#).
...
things, including:
  ...
  - TCP implementation/interoperability bugs. See the
    [../SystemWeirdnesses](https://wiki.squid-cache.org/SquidFaq/TroubleShooting/SquidFaq/SystemWeirdnesses#)
    for details.
...
use [a short C
program](https://wiki.squid-cache.org/SquidFaq/TroubleShooting/SquidFaq/TroubleShooting?action=AttachFile&do=get&target=zerosized_reply.c).
...
[Squid-3.1](https://wiki.squid-cache.org/SquidFaq/TroubleShooting/Squid-3.1#).
...
[../OperatingSquid](https://wiki.squid-cache.org/SquidFaq/TroubleShooting/SquidFaq/OperatingSquid#).

# Problems with Windows update

  - see
    [SquidFaq/WindowsUpdate](https://wiki.squid-cache.org/SquidFaq/TroubleShooting/SquidFaq/WindowsUpdate#)

Back to the
[SquidFaq](https://wiki.squid-cache.org/SquidFaq/TroubleShooting/SquidFaq#)
