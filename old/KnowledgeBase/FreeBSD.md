...
The [general build
instructions](https://wiki.squid-cache.org/KnowledgeBase/FreeBSD/SquidFaq/CompilingSquid#)
...
[CategoryKnowledgeBase](https://wiki.squid-cache.org/KnowledgeBase/FreeBSD/CategoryKnowledgeBase#)
[CategoryUpdated](https://wiki.squid-cache.org/KnowledgeBase/FreeBSD/CategoryUpdated#)
