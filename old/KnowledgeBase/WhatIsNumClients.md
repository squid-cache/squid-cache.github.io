...
In the [cache
manager](https://wiki.squid-cache.org/KnowledgeBase/WhatIsNumClients/SquidFaq/CacheManager#)'s
...
[CategoryKnowledgeBase](https://wiki.squid-cache.org/KnowledgeBase/WhatIsNumClients/CategoryKnowledgeBase#)
