...
[NgTech](https://wiki.squid-cache.org/KnowledgeBase/CentOS/NgTech#)
repository for quite some time to:

  - [](http://linuxsoft.cern.ch/mirror/www1.ngtech.co.il/repo/centos/7/)

[CategoryKnowledgeBase](https://wiki.squid-cache.org/KnowledgeBase/CentOS/CategoryKnowledgeBase#)
[SquidFaq/BinaryPackages](https://wiki.squid-cache.org/KnowledgeBase/CentOS/SquidFaq/BinaryPackages#)
