...
[BuildFarm](https://wiki.squid-cache.org/KnowledgeBase/Debian/BuildFarm#)
  ...
  - ![{i}](https://wiki.squid-cache.org/wiki/squidtheme/img/icon-info.png)
    The usual one requested is **libssl-dev** for SSL support.
      ...
      - ![/\!\\](https://wiki.squid-cache.org/wiki/squidtheme/img/alert.png)
        ...
        [Squid-3.5](https://wiki.squid-cache.org/KnowledgeBase/Debian/Squid-3.5#)
        ...
        [Squid-4](https://wiki.squid-cache.org/KnowledgeBase/Debian/Squid-4#)
        packages.
...
The **squid-dbg** (or **squid3-dbg**) packages provides debug symbols
needed for bug reporting if the bug is crash related. See the [Bug
Reporting
FAQ](https://wiki.squid-cache.org/KnowledgeBase/Debian/SquidFaq/BugReporting#)
...
[CategoryKnowledgeBase](https://wiki.squid-cache.org/KnowledgeBase/Debian/CategoryKnowledgeBase#)
[SquidFaq/BinaryPackages](https://wiki.squid-cache.org/KnowledgeBase/Debian/SquidFaq/BinaryPackages#)
