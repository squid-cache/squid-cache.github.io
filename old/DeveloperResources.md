...
to
[SquidCodingGuidelines](https://wiki.squid-cache.org/DeveloperResources/SquidCodingGuidelines#)
and follow the
[MergeProcedure](https://wiki.squid-cache.org/DeveloperResources/MergeProcedure#).

[ProgrammingGuide](https://wiki.squid-cache.org/DeveloperResources/ProgrammingGuide#)
provides a broad overview of Squid architecture and details some of
Squid modules. It also discusses [manual page
writing](https://wiki.squid-cache.org/DeveloperResources/ProgrammingGuide/ManualDocumentation#).
...
Finding things to do:
  ...
  - [RoadMap](https://wiki.squid-cache.org/DeveloperResources/RoadMap#)
    lists the feature wishes and plans for future releases.

  - [RoadMap/Tasks](https://wiki.squid-cache.org/DeveloperResources/RoadMap/Tasks#)
    itemizes general cleanup tasks that need to be done. These can be
    good introductory tasks.

  - [HTTP/1.1
    compliance](https://wiki.squid-cache.org/DeveloperResources/Features/HTTP11#)
...
[BuildFarm](https://wiki.squid-cache.org/DeveloperResources/BuildFarm#).
...
[GitHints](https://wiki.squid-cache.org/DeveloperResources/GitHints#)
...
[ProgrammingGuide/Bootstrap](https://wiki.squid-cache.org/DeveloperResources/ProgrammingGuide/Bootstrap#).

# Miscellaneous

[ReleaseProcess](https://wiki.squid-cache.org/DeveloperResources/ReleaseProcess#)
describes the process and criteria used by the Squid Developers when
making new Squid releases from the accepted changes.

[WhoWeAre](https://wiki.squid-cache.org/DeveloperResources/WhoWeAre#)
...
[MeetUps](https://wiki.squid-cache.org/DeveloperResources/MeetUps#).
