...
| Aug 2012 | the Squid-2.6 series became **OBSOLETE** with the release of [Squid-3.2](https://wiki.squid-cache.org/Squid-2.6/Squid-3.2#) features                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| May 2008 | the Squid-2.6 series became **DEPRECATED** with the release of [Squid-2.7](https://wiki.squid-cache.org/Squid-2.6/Squid-2.7#) series                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
[Squid-3.0](https://wiki.squid-cache.org/Squid-2.6/Squid-3.0#) ready.
...
([Henrik\_Nordström](https://wiki.squid-cache.org/Squid-2.6/Henrik_Nordstr%C3%B6m#),
[FrancescoChemolli](https://wiki.squid-cache.org/Squid-2.6/FrancescoChemolli#)
& our kind host
[GuidoSerassio](https://wiki.squid-cache.org/Squid-2.6/GuidoSerassio#))
...
[Squid-3.0](https://wiki.squid-cache.org/Squid-2.6/Squid-3.0#) to
stabilize.
