...
|          |                                                                                                                              |
| -------- | ---------------------------------------------------------------------------------------------------------------------------- |
| Jul 2018 | Squid-3.5 series became **DEPRECATED** with the release of [Squid-4](https://wiki.squid-cache.org/Squid-3.5/Squid-4#) series |
...
Basic new features in 3.5:
  ...
  - Caching large (\>32KB) objects in [Rock
    storage](https://wiki.squid-cache.org/Squid-3.5/Features/LargeRockStore#)
  ...
  - [Native FTP protocol
    relay](https://wiki.squid-cache.org/Squid-3.5/Features/FtpRelay#)
...
Features removed in 3.5:
  ...
  - COSS storage type has been superceded by
    [Rock](https://wiki.squid-cache.org/Squid-3.5/Features/LargeRockStore#)
    storage type.
