...
| Dec 2013 | the Squid-3.3 series became **DEPRECATED** with the release of [Squid-3.4](https://wiki.squid-cache.org/Squid-3.3/Squid-3.4#) series                                                                                                                                                                                                                                        |
...
Basic new features in 3.3:
  ...
  - [Features/BumpSslServerFirst](https://wiki.squid-cache.org/Squid-3.3/Features/BumpSslServerFirst#)

  - [Features/MimicSslServerCert](https://wiki.squid-cache.org/Squid-3.3/Features/MimicSslServerCert#)
