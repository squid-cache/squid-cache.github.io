...
[KnowledgeBase/NTLMAuthGoryDetails](https://wiki.squid-cache.org/NTLMIssues/KnowledgeBase/NTLMAuthGoryDetails#)
...
the next-hop proxy using NTLM.
  ...
  - ![{i}](https://wiki.squid-cache.org/wiki/squidtheme/img/icon-info.png)
    ...
    [Squid-3.2](https://wiki.squid-cache.org/NTLMIssues/Squid-3.2#) does
    support Kerberos (Negotiate) login to upstream proxies.
