...
|| ||
||#8 ||HenrikNordstrom ||to verify bugzilla migration ||not done ||
||#8 ||HenrikNordstrom ||send public announcement about new sysadmin staff (pending bugzilla task verification) ||not done ||
||#8 ||HenrikNordstrom, AmosJeffries ||investigate project changeset statistics error ||not done ||
