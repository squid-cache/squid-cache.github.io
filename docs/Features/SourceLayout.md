...
| :frowning:         | :frowning:         | :frowning:         | :frowning:         | :frowning:         | clientdb/ :two:  | Database of information about clients                                                              | PR 954 client_db.*                                                                |
...
| :neutral_face:     | :frowning:         | :frowning:         | :frowning:         | :frowning:         | cfg/ :two:       | squid.conf parsing and management                                                                  | PR 928, cache_cf.*cf.* cf_* Parser.* ConfigParser.* ConfigOption.*               |
...
| :frowning:         | -                  | -                  | :frowning:         | -                  | fs/aufs          | AUFS cache_dir                                                                                     | FrancescoChemolli. Fs::Ufs namespace, renamed files. TODO: rename classes         |
...
| :frowning:         | :frowning:         | :frowning:         | :frowning:         | :frowning:         | shaping/ :two:   | Traffic shaping and delay pools                                                                    | PR 928, *[Dd]elay.* *[Pp]ool*.*                                                   |
