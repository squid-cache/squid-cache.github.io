...
On Windows, [cache
manager](https://wiki.squid-cache.org/KnowledgeBase/Windows/Features/CacheManager#)
...
## Configuration Guides
  ...
  - [Windows
    Update](https://wiki.squid-cache.org/KnowledgeBase/Windows/SquidFaq/WindowsUpdate#)

  - [Active Directory
    Authentication](https://wiki.squid-cache.org/KnowledgeBase/Windows/ConfigExamples/Authenticate/WindowsActiveDirectory#)

  - [Kerberos
    Authentication](https://wiki.squid-cache.org/KnowledgeBase/Windows/ConfigExamples/Authenticate/Kerberos#)

  - [NTLM
    Authentication](https://wiki.squid-cache.org/KnowledgeBase/Windows/ConfigExamples/Authenticate/Ntlm#)
    ([with
    Groups](https://wiki.squid-cache.org/KnowledgeBase/Windows/ConfigExamples/Authenticate/NtlmWithGroups#))

These and many other general manuals in the
[ConfigExamples](https://wiki.squid-cache.org/KnowledgeBase/Windows/ConfigExamples#)
section.
...
**Squid-3** : (requires
[Squid-3.5](https://wiki.squid-cache.org/KnowledgeBase/Windows/Squid-3.5#)
...
[AmosJeffries](https://wiki.squid-cache.org/KnowledgeBase/Windows/AmosJeffries#)
...
[Squid-3.2](https://wiki.squid-cache.org/KnowledgeBase/Windows/Squid-3.2#)
and
[Squid-3.3](https://wiki.squid-cache.org/KnowledgeBase/Windows/Squid-3.3#).
...
<!-- end list -->
  ...
  - This builds for
    ...
    [MingW32](https://wiki.squid-cache.org/KnowledgeBase/Windows/MingW32#)
    is required.
...
[Squid-2.7](https://wiki.squid-cache.org/KnowledgeBase/Windows/Squid-2.7#).
...
[CategoryKnowledgeBase](https://wiki.squid-cache.org/KnowledgeBase/Windows/CategoryKnowledgeBase#)
