...
**Thanks**
  ...
  - [HenrikNordstrom](https://wiki.squid-cache.org/KnowledgeBase/VaryNotCaching/HenrikNordstrom#)
    - providing information on the Vary code behaviour

[CategoryKnowledgeBase](https://wiki.squid-cache.org/KnowledgeBase/VaryNotCaching/CategoryKnowledgeBase#)
[CategoryKnowledgeBase](https://wiki.squid-cache.org/KnowledgeBase/VaryNotCaching/CategoryKnowledgeBase#)
