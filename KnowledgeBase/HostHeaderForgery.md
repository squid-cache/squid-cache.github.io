...
[Squid-3.2](https://wiki.squid-cache.org/KnowledgeBase/HostHeaderForgery/Squid-3.2#)
...
**Fix**
  ...
  - use the
    [WPAD/PAC](https://wiki.squid-cache.org/KnowledgeBase/HostHeaderForgery/SquidFaq/ConfiguringBrowsers#Fully_Automatic_Configuration)
...
**Workaround**
  ...
  - ![{i}](https://wiki.squid-cache.org/wiki/squidtheme/img/icon-info.png)
    As of May 2012,
    [Squid-3.2.0.18](https://wiki.squid-cache.org/KnowledgeBase/HostHeaderForgery/Squid-3.2#)
...
[CategoryKnowledgeBase](https://wiki.squid-cache.org/KnowledgeBase/HostHeaderForgery/CategoryKnowledgeBase#)
[CategoryErrorMessages](https://wiki.squid-cache.org/KnowledgeBase/HostHeaderForgery/CategoryErrorMessages#)
