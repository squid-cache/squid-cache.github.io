...
## <<TableOfContents>>
== System Setup ==
As of April 2011, the squid build farm main node runs the [[http://www.linux-kvm.org|KVM]] virtualization hypervisor. Build instructions:
 ...
 1. add packages: {{{pkg_add jre bzr cppunit libxml ccache autoconf automake libtool m4 bash}}}
