...
see
[SquidFaq/BinaryPackages](https://wiki.squid-cache.org/SquidFaq/CompilingSquid/SquidFaq/BinaryPackages#)
...
### [CentOS](https://wiki.squid-cache.org/SquidFaq/CompilingSquid/KnowledgeBase/CentOS)
...
### [Debian, Ubuntu](https://wiki.squid-cache.org/SquidFaq/CompilingSquid/KnowledgeBase/Debian)

Many versions of Ubuntu and Debian are routinely build-tested and
unit-tested as part of our
[BuildFarm](https://wiki.squid-cache.org/SquidFaq/CompilingSquid/BuildFarm#)
  ...
  - ![{i}](https://wiki.squid-cache.org/wiki/squidtheme/img/icon-info.png)
    The usual one requested is **libssl-dev** for SSL support.
      ...
      - ![/\!\\](https://wiki.squid-cache.org/wiki/squidtheme/img/alert.png)
        ...
        [Squid-3.5](https://wiki.squid-cache.org/SquidFaq/CompilingSquid/Squid-3.5#)
        ...
        [Squid-4](https://wiki.squid-cache.org/SquidFaq/CompilingSquid/Squid-4#)
        packages.
...
### [Fedora](https://wiki.squid-cache.org/SquidFaq/CompilingSquid/KnowledgeBase/Fedora)
...
### [FreeBSD, NetBSD, OpenBSD](https://wiki.squid-cache.org/SquidFaq/CompilingSquid/KnowledgeBase/FreeBSD)

The [general build
instructions](https://wiki.squid-cache.org/SquidFaq/CompilingSquid/SquidFaq/CompilingSquid#)
...
### [Windows](https://wiki.squid-cache.org/SquidFaq/CompilingSquid/KnowledgeBase/Windows)
...
### [RedHat, RHEL](https://wiki.squid-cache.org/SquidFaq/CompilingSquid/KnowledgeBase/RedHat)
...
### [Solaris](https://wiki.squid-cache.org/SquidFaq/CompilingSquid/KnowledgeBase/Solaris)
...
[Squid-3.1](https://wiki.squid-cache.org/SquidFaq/CompilingSquid/Squid-3.1#)
...
platforms](https://wiki.squid-cache.org/SquidFaq/CompilingSquid/SquidFaq/AboutSquid#What_Operating_Systems_does_Squid_support.3F)
...
Back to the
[SquidFaq](https://wiki.squid-cache.org/SquidFaq/CompilingSquid/SquidFaq#)
