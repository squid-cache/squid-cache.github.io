...
outlined in the
[KnowledgeBase](https://wiki.squid-cache.org/SquidFaq/SquidLogs/KnowledgeBase#):
...
[Squid-2.7](https://wiki.squid-cache.org/SquidFaq/SquidLogs/Squid-2.7#)
and
[Squid-3.2](https://wiki.squid-cache.org/SquidFaq/SquidLogs/Squid-3.2#)
allow the administrators to configure their [logfile
format](https://wiki.squid-cache.org/SquidFaq/SquidLogs/Features/LogFormat#)
and [log output
method](https://wiki.squid-cache.org/SquidFaq/SquidLogs/Features/LogModules#)
...
underscore characters) which describe the response sent to the client.
  ...
  - These tags are optional and describe what type of object was
    ...
    | **REDIRECT**   | Squid generated an HTTP redirect response to this request. Only on [Squid-3.2](https://wiki.squid-cache.org/SquidFaq/SquidLogs/Squid-3.2#)+ or Squid built with -DLOG\_TCP\_REDIRECTS compiler flag.                                                |
  ...
  - These tags are optional and describe whether the response was loaded
    ...
    | **TUNNEL**  | A binary tunnel was established for this transaction. Only on [Squid-3.5](https://wiki.squid-cache.org/SquidFaq/SquidLogs/Squid-3.5#)+                                                                                                                                  |
...
will not see such a file.
  ...
  - ![/\!\\](https://wiki.squid-cache.org/wiki/squidtheme/img/alert.png)
    [RunCache](https://wiki.squid-cache.org/SquidFaq/SquidLogs/RunCache#)
    has been obsoleted since
    [Squid-2.6](https://wiki.squid-cache.org/SquidFaq/SquidLogs/Squid-2.6#).
...
See the [Log Modules
feature](https://wiki.squid-cache.org/SquidFaq/SquidLogs/Features/LogModules#)
for technical details on setting up a daemon or other output modules.

Back to the
[SquidFaq](https://wiki.squid-cache.org/SquidFaq/SquidLogs/SquidFaq#)
