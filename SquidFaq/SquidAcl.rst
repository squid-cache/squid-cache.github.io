...
(original answer by HenrikNordström)

By default the maximum length of an ACL name is 32 characters, but it can be changed by editing the source: in ''defines.h''
{{{
