...
[SSL-Bump](https://wiki.squid-cache.org/SquidFaq/InterceptionProxy/Features/SslBump#)
...
box use [policy
routing](https://wiki.squid-cache.org/SquidFaq/InterceptionProxy/ConfigExamples/Intercept/IptablesPolicyRoute#).
...
[ConfigExamples/Intercept](https://wiki.squid-cache.org/SquidFaq/InterceptionProxy/ConfigExamples/Intercept#)
...
[ReubenFarrelly](https://wiki.squid-cache.org/SquidFaq/InterceptionProxy/ReubenFarrelly#).
...
[Squid-2.6](https://wiki.squid-cache.org/SquidFaq/InterceptionProxy/Squid-2.6#)
and
[Squid-3.0](https://wiki.squid-cache.org/SquidFaq/InterceptionProxy/Squid-3.0#).
...
[StevenWilton](https://wiki.squid-cache.org/SquidFaq/InterceptionProxy/StevenWilton#)
...
Feature](https://wiki.squid-cache.org/SquidFaq/InterceptionProxy/Features/Tproxy4#)
for current details.
...
[../ProxyAuthentication](https://wiki.squid-cache.org/SquidFaq/InterceptionProxy/SquidFaq/ProxyAuthentication#)
and
[Features/NegotiateAuthentication](https://wiki.squid-cache.org/SquidFaq/InterceptionProxy/Features/NegotiateAuthentication#)).
...
[DuaneWessels](https://wiki.squid-cache.org/SquidFaq/InterceptionProxy/DuaneWessels#)
...
more details on that and some solutions.
  ...
  - Back to the
    [SquidFaq](https://wiki.squid-cache.org/SquidFaq/InterceptionProxy/SquidFaq#)
