...
|| May 2008 || the active Squid developers are now concentrating all new features and developments at Squid-3 or later. If those versions do not meet your requirements please contact squid-dev about the missing features. The list [[http://www.squid-cache.org/Versions/v3/3.5/RELEASENOTES.html#s5|to be ported]] is quite small and shrinking. ||
