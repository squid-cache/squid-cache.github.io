#acl AlexRousskov:read,write,admin AmosJeffries:read,write,admin FrancescoChemolli:read,write,admin Henrik_Nordström:read,write,admin -All:read,write,admin
