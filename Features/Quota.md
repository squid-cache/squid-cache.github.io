...
sessions over HTTP) may bypass the quota controls.
  ...
  - ext\_time\_quota\_acl helper added with
    [Squid-3.3](https://wiki.squid-cache.org/Features/Quota/Squid-3.3#)
...
[CategoryFeature](https://wiki.squid-cache.org/Features/Quota/CategoryFeature#)
[CategoryWish](https://wiki.squid-cache.org/Features/Quota/CategoryWish#)
