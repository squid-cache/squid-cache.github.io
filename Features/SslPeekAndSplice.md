# Feature: SslBump Peek and Splice
  ...
  - **Developer**:
    [AlexRousskov](https://wiki.squid-cache.org/Features/SslPeekAndSplice/AlexRousskov#)
...
[SslBump](https://wiki.squid-cache.org/Features/SslPeekAndSplice/Features/SslBump#)
actions and related features introduced in
[Squid-3.5](https://wiki.squid-cache.org/Features/SslPeekAndSplice/Squid-3.5#).
...
2.  Go through the [Callout
    Sequence](https://wiki.squid-cache.org/Features/SslPeekAndSplice/SquidFaq/OrderIsImportant#Callout_Sequence)
...
<tbody>
<tr class="odd">
<td><p>pre-3.5 actions are listed below for completeness sake only; <em>do not use these with <a href="https://wiki.squid-cache.org/Features/SslPeekAndSplice/Squid-3.5#">Squid-3.5</a> and newer</em></p></td>
<td></td>
<td></td>
</tr>
<tr class="even">
...
<td><p>step1</p></td>
<td><p>Ancient <a href="https://wiki.squid-cache.org/Features/SslPeekAndSplice/Squid-3.1#">Squid-3.1</a> style bumping: Establish a secure connection with the client first, then connect to the server. Cannot mimic server certificate well, which causes a lot of problems.</p></td>
</tr>
<tr class="odd">
<td><p><strong>server-first</strong></p></td>
<td><p>step1</p></td>
<td><p>Old <a href="https://wiki.squid-cache.org/Features/SslPeekAndSplice/Squid-3.3#">Squid-3.3</a> style bumping: Establish a secure connection with the server first, then establish a secure connection with the client, using a mimicked server certificate. Does not support peeking, which causes various problems.</p>
...
If
[Squid-4](https://wiki.squid-cache.org/Features/SslPeekAndSplice/Squid-4#)
...
[CategoryFeature](https://wiki.squid-cache.org/Features/SslPeekAndSplice/CategoryFeature#)
