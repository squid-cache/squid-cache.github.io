...
## but you may want to at least move the Goal description to here
## when its complete if a better description is not available.
## If you have multiple sections and ToC, please place them here,
## leaving the above summary information in the page "header".

= Configuration =
##
## use to document squid.conf settings needed to use this feature (if any)
